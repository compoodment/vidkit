...
set +e
VIDKIT_WIDTH="${VIDKIT_WIDTH:-1280}" VIDKIT_HEIGHT="${VIDKIT_HEIGHT:-720}" VIDKIT_FPS="${VIDKIT_FPS:-24}" VIDKIT_DURATION="${VIDKIT_DURATION:-120}" VIDKIT_SAMPLES="${VIDKIT_SAMPLES:-40}" VIDKIT_CYCLES_DEVICE="${VIDKIT_CYCLES_DEVICE:-CUDA}" \
